# libcoraza Java SWIG example

A minimal Java binding example for [libcoraza](https://github.com/corazawaf/libcoraza)
...
Then build the Java binding from this directory:
...
`SimpleGet.java` exercises all SWIG-exported libcoraza functions testable without a
native callback:
...
> See the [SWIG documentation](https://www.swig.org/Doc4.2/Java.html) for details.
